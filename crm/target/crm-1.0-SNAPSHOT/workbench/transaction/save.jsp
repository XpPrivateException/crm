...
<body>
	...
	<form action="workbench/transaction/saveTran.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-possibility"  onfocus="this.blur()"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="发传单10">
				<input type="hidden" id="create-activityId" name="activityId" value="379f298c3a654f618f98885ebd592eb9" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="刘强东"/>
				<input type="hidden" id="create-contactsNameId" name="contactsName" value="281696dd0f914c0cb56a280b206cd6d8" />
			</div>
		</div>
